...
export const AnimationProjects: Project[] = [
  {
    ...
    description:
        'Este es un proyecto estilo "Couch Gag", el cual combina dos intros de series de la cadena anteriormente conocida como "FOX". Estos se hicieron únicamente con propósito educativo y sin ningún tipo de remuneración. Esta animación fue hecha durante 2 semanas usando los programas Adobe Photoshop y Adobe After Effects.',
  ...
  },
  {
    ...
    description:
        'Este es un experimento hecho con rotoscopia y Adobe Photoshop, el cual tenía como propósito la práctica de animación sobre material de archivo. Este se hizo con clips del largometraje "Spider-Man 3" con propósito educativo y sin ningún tipo de remuneración. Fue realizado en 1 semana usando Adobe Photoshop.',
  ...
  },
  {
    ...
    description:
        'Este es un cortometraje el cual dirigí y edité en 2025. Este fue un proceso de 2 meses en el cual estuve planeando, generando el guion, haciendo el casting y editándolo en postproducción. Esto fue realizado junto a un asistente de producción, 2 actores principales y 8 actores de reparto. Fue editado usando Adobe Premiere Pro en conjunto con la Universidad de los Andes.',
  ...
  },
  {
    ...
    description:
        'Este es un cortometraje que se produjo junto a un equipo de 3 personas, donde tuve el papel de director. Este tiene como intención artística ilustrar la vida de un humilde creador de velas que quiere reconectar con su hijo. Fue producido en colaboración con la Universidad de los Andes.',
...
export const AnimationProjectsEn: Project[] = [
  ...
  },
  {
    ...
    title: 'Deraíz',
    description:
        'This project was developed in collaboration with the Universidad de los Andes. Its purpose was to create an artistic visual expression movement by combining analog and digital techniques. It was a collaborative team effort where all members worked toward a shared creative objective. The animation was produced in authorized graffiti spaces and later composited in Photoshop. Original publication: https://www.instagram.com/reel/DKHhPdvN8NO/?utm_source=ig_web_button_share_sheet&igsh=MzRlODBiNWFlZA==',
    iframeSrc: 'https://drive.google.com/file/d/101m-0jSkYCH9VfXZf97SYLNLjBeLZI6Z/preview',
    section: '2025',
  },
  {
